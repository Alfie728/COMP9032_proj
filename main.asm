...
VEditVal:              .byte 1
VEditCnt:              .byte 1
ButtonPressCnt: 	   .byte 1           ; counts PB0/PB1 presses (bit0 used in pause)
...
;CHECK IF PB0 OR PB1 PRESSED AND HANDLE INTERRUPTS
;-------------------------------------------------------------------------------
...
hc_do_s4:
    ...
    cpi workA, 0
pause_wait_pb0:
    ; Wait until PB0 interrupt records a press (bit0 in ButtonPressCnt)
